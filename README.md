...
2-	customers : Details of all the customers . City id refers to the id of cities table and it tells you to the home city of the  customer 			3-	hotels: details of each hotel . City id refers to id in city table and this tells you the city where hotel is located												4-	cities : details of each city along with state where it is located														
