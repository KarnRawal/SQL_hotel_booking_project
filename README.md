...
Gender Split: Revenue and bookings are almost perfectly even between genders — Female customers contribute 50.2% of revenue (2,478 bookings) vs. Male at 49.8% (2,476 bookings). At the hotel level, female revenue share ranges narrowly from 47.9% (The Oberoi) to 52.8% (Royal Orchid) — no hotel skews meaningfully toward one gender.
